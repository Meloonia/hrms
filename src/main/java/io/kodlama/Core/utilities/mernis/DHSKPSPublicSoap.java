...
public class DHSKPSPublicSoap
{
    ...
    public DHSKPSPublicSoap(){}

    public DHSKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public DHSKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        DHSExtendedSoapSerializationEnvelope envelope= new DHSExtendedSoapSerializationEnvelope(DHSExtendedSoapSerializationEnvelope.VER11);
