...
public class DHSExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(DHSDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new DHSStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static DHSDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static DHSDateTimeConverter dateTimeConverter = new DHSStandardDateTimeConverter();

    public DHSExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public DHSExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new DHSMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=DHSHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,DHSExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=DHSHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
