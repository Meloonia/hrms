...
public class TQHExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(TQHDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new TQHStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static TQHDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static TQHDateTimeConverter dateTimeConverter = new TQHStandardDateTimeConverter();

    public TQHExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public TQHExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new TQHMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=TQHHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    public SoapObject GetSoapObject(Element detailElement) {
        ...
        catch (java.lang.Exception e)
        {
			if(enableLogging)
			{
	//			android.util.Log.e(TQHExtendedSoapSerializationEnvelope.TAG,"Error occured",e);
			}
        }
        return null;
    }
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,TQHExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=TQHHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
